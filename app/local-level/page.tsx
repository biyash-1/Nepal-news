...
import { useLocalNews } from "@/app/hooks/useLocalNews";

export default function LocalLevelPage() {
  const { mainHeadline, freshNews, moreNews, loading, error, refreshData } =
    useLocalNews();
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-6" style={{ width: '75%' }}>
        ...
        {/* Middle Section - ताजा स्थानीय समाचार */}
        {freshNews.length > 0 && (
          <div className="mb-10">
        ...
        {/* थप स्थानीय समाचार - Infinite Scroll */}
