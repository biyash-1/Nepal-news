...
const getImageUrl = (article: any) => {
  return (
    ...
    article?.image ||
    "https://images.unsplash.com/photo-1478720568477-152d9b164e26?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80"
  );
};
...
const celebrities = [
  ...
  },
  {
    ...
    role: "गायक",
    image:
      "https://images.unsplash.com/photo-1511379938547-c1f69419868d?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80",
  },
  {
    name: "रेखा थापा",
    role: "निर्देशक",
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-50">
      ...
      <div className="w-[75%] mx-auto py-6 ">
        <div className="flex items-center justify-between">
          <h3 className="text-3xl border-l-4 border-red-600 font-bold text-gray-900 pl-3">
            मनोरञ्जन
          </h3>
          <Link
                    ...
                    trendingNews.map((trend: any, index: number) => (
                      ...
                      >
                        <img
                          src={getImageUrl(trend)}
                          alt={trend.title}
                          className="w-26 h-18 object-cover rounded mb-1"
                        />
                        <span className="text-gray-800 font-semibold text-base font-medium flex-1">
                          {trend.title}
                        </span>
                      </Link>
                    ))
